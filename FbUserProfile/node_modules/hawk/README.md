...
A browser script is provided for including using a `<script>` tag in [lib/browser.js](/public/lib/browser.js). It's also a [component](http://component.io/hueniverse/hawk).
